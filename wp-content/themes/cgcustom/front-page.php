...
<section id="image-section">
  <div class="container">
    <div class="image-show">
      <img class="first" src="<?php echo get_template_directory_uri(); ?>/assets/images/picture1.jpg" alt="Pic1">
      <img class="second" src="<?php echo get_template_directory_uri(); ?>/assets/images/picture2.jpg" alt="Pic2">
    </div>
  </div>
</section>
